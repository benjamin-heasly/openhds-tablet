...
public class OpenHDS {
    ...
    public static final class LocationHierarchies implements BaseColumns {
    ...
    public static final class LocationHierarchyLevels implements BaseColumns {
    ...
    public static final class Residencies implements BaseColumns {
