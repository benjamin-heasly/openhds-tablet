...
public class ChecklistFormInstanceAdapter extends ArrayAdapter {
    ...
    public ChecklistFormInstanceAdapter(Context context, int resource, ArrayList<FormInstance> formInstances, ArrayList<Boolean> checkList) {
