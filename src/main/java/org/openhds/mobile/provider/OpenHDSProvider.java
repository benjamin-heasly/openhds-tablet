...
public class OpenHDSProvider extends ContentProvider {
	...
	static {
		...
		individualsProjectionMap.put(OpenHDS.Individuals.COLUMN_INDIVIDUAL_FIRST_NAME,
		...
		individualsProjectionMap.put(OpenHDS.Individuals.COLUMN_INDIVIDUAL_LAST_NAME,
		...
		individualsProjectionMap.put(OpenHDS.Individuals.COLUMN_INDIVIDUAL_RESIDENCE_LOCATION_EXTID,
				OpenHDS.Individuals.COLUMN_INDIVIDUAL_RESIDENCE_LOCATION_EXTID);
		individualsProjectionMap.put(OpenHDS.Individuals.COLUMN_INDIVIDUAL_RESIDENCE_END_TYPE,
				OpenHDS.Individuals.COLUMN_INDIVIDUAL_RESIDENCE_END_TYPE);
		individualsProjectionMap.put(OpenHDS.Individuals.COLUMN_INDIVIDUAL_FULL_NAME,
				OpenHDS.Individuals.COLUMN_INDIVIDUAL_FIRST_NAME + " || ' ' || "
						+ OpenHDS.Individuals.COLUMN_INDIVIDUAL_LAST_NAME + " as "
						+ OpenHDS.Individuals.COLUMN_INDIVIDUAL_FULL_NAME);

		// extensions for bioko project
		individualsProjectionMap.put(OpenHDS.Individuals.COLUMN_INDIVIDUAL_OTHER_NAMES,
		...
		individualsProjectionMap.put(OpenHDS.Individuals.COLUMN_INDIVIDUAL_AGE_UNITS,
				OpenHDS.Individuals.COLUMN_INDIVIDUAL_AGE_UNITS);
		individualsProjectionMap.put(OpenHDS.Individuals.COLUMN_INDIVIDUAL_PHONE_NUMBER,
				OpenHDS.Individuals.COLUMN_INDIVIDUAL_PHONE_NUMBER);
		individualsProjectionMap.put(OpenHDS.Individuals.COLUMN_INDIVIDUAL_OTHER_PHONE_NUMBER,
				OpenHDS.Individuals.COLUMN_INDIVIDUAL_OTHER_PHONE_NUMBER);
		individualsProjectionMap.put(OpenHDS.Individuals.COLUMN_INDIVIDUAL_LANGUAGE_PREFERENCE,
				OpenHDS.Individuals.COLUMN_INDIVIDUAL_LANGUAGE_PREFERENCE);
		individualsProjectionMap.put(OpenHDS.Individuals.COLUMN_INDIVIDUAL_OTHER_ID,
		...
		relationshipsProjectionMap.put(OpenHDS.Relationships.COLUMN_RELATIONSHIP_TYPE,
		...
		socialgroupsProjectionMap.put(OpenHDS.SocialGroups.COLUMN_SOCIAL_GROUP_HEAD_INDIVIDUAL_EXTID,
		...
		socialgroupsJoinProjectionMap.put(OpenHDS.SocialGroups.COLUMN_SOCIAL_GROUP_EXTID, "s."
				+ OpenHDS.SocialGroups.COLUMN_SOCIAL_GROUP_EXTID);
		socialgroupsJoinProjectionMap.put(OpenHDS.SocialGroups.COLUMN_SOCIAL_GROUP_HEAD_INDIVIDUAL_EXTID,
				"s." + OpenHDS.SocialGroups.COLUMN_SOCIAL_GROUP_HEAD_INDIVIDUAL_EXTID);
		...
		membershipsProjectionMap.put(OpenHDS.Memberships.COLUMN_INDIVIDUAL_EXTID,
				OpenHDS.Memberships.COLUMN_INDIVIDUAL_EXTID);
		membershipsProjectionMap.put(OpenHDS.Memberships.COLUMN_SOCIAL_GROUP_EXTID,
				OpenHDS.Memberships.COLUMN_SOCIAL_GROUP_EXTID);
		membershipsProjectionMap.put(OpenHDS.Memberships.COLUMN_MEMBERSHIP_RELATIONSHIP_TO_HEAD,
				OpenHDS.Memberships.COLUMN_MEMBERSHIP_RELATIONSHIP_TO_HEAD);

		membershipsProjectionMap.put(OpenHDS.Memberships.COLUMN_MEMBERSHIP_STATUS,
	...
	static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			db.execSQL("CREATE TABLE " + OpenHDS.Individuals.TABLE_NAME + " (" + OpenHDS.Individuals._ID
					...
					+ OpenHDS.Individuals.COLUMN_INDIVIDUAL_RESIDENCE_LOCATION_EXTID + " TEXT,"
			...
			db.execSQL("CREATE TABLE " + OpenHDS.Rounds.TABLE_NAME + " (" + OpenHDS.Rounds._ID
					...
					+ OpenHDS.Rounds.COLUMN_ROUND_STARTDATE + " TEXT NOT NULL);");
			...
			db.execSQL("CREATE TABLE " + OpenHDS.Relationships.TABLE_NAME + " (" + OpenHDS.Relationships._ID
					...
					+ " TEXT NOT NULL," + OpenHDS.Relationships.COLUMN_RELATIONSHIP_INDIVIDUAL_B
					+ " TEXT NOT NULL," + OpenHDS.Relationships.COLUMN_RELATIONSHIP_TYPE + " TEXT NOT NULL,"
			...
			db.execSQL("CREATE TABLE " + OpenHDS.FieldWorkers.TABLE_NAME + " (" + OpenHDS.FieldWorkers._ID
					+ " INTEGER PRIMARY KEY," + OpenHDS.FieldWorkers.COLUMN_FIELD_WORKER_EXTID
					+ " TEXT NOT NULL," + OpenHDS.FieldWorkers.COLUMN_FIELD_WORKER_FIRST_NAME
					+ " TEXT NOT NULL," + OpenHDS.FieldWorkers.COLUMN_FIELD_WORKER_LAST_NAME
					+ " TEXT NOT NULL," + OpenHDS.FieldWorkers.COLUMN_FIELD_WORKER_PASSWORD
					+ " TEXT NOT NULL);");

			db.execSQL("CREATE TABLE " + OpenHDS.SocialGroups.TABLE_NAME + " (" + OpenHDS.SocialGroups._ID
					+ " INTEGER PRIMARY KEY," + OpenHDS.SocialGroups.COLUMN_SOCIAL_GROUP_EXTID
					+ " TEXT NOT NULL," + OpenHDS.SocialGroups.COLUMN_SOCIAL_GROUP_HEAD_INDIVIDUAL_EXTID
					+ " TEXT NOT NULL," + OpenHDS.SocialGroups.COLUMN_SOCIAL_GROUP_NAME + " TEXT NOT NULL);");

			db.execSQL("CREATE TABLE " + OpenHDS.Memberships.TABLE_NAME + " (" + OpenHDS.Memberships._ID
					+ " INTEGER PRIMARY KEY," + OpenHDS.Memberships.COLUMN_INDIVIDUAL_EXTID
					+ " TEXT NOT NULL," + OpenHDS.Memberships.COLUMN_SOCIAL_GROUP_EXTID + " TEXT NOT NULL,"
					+ OpenHDS.Memberships.COLUMN_MEMBERSHIP_RELATIONSHIP_TO_HEAD + " TEXT NOT NULL,"
					+ OpenHDS.Memberships.COLUMN_MEMBERSHIP_STATUS + " TEXT NOT NULL);");
		}
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
		...
		case ROUND_ID:
			...
			qb.appendWhere(OpenHDS.Rounds._ID + "="
					+ uri.getPathSegments().get(OpenHDS.Rounds.ID_PATH_POSITION));
			break;
		case VISITS:
		...
		case VISIT_ID:
			...
			qb.appendWhere(OpenHDS.Visits._ID + "="
					+ uri.getPathSegments().get(OpenHDS.Visits.ID_PATH_POSITION));
			break;
		case RELATIONSHIPS:
	...
	private String[] addSocialGroupExtIds(SQLiteQueryBuilder qb, String string) {
		...
		while (c.moveToNext()) {
			Cursor c2 = db.query(OpenHDS.Memberships.TABLE_NAME,
					...
					OpenHDS.Memberships.COLUMN_INDIVIDUAL_EXTID + " = ?", new String[] { c.getString(0) },
					null, null, null);
			while (c2.moveToNext()) {
