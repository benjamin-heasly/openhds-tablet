...
public class StateMachine {
    ...
    public enum State {
        SELECT_HIERARCHY_1, SELECT_HIERARCHY_2, SELECT_HIERARCHY_3, SELECT_HIERARCHY_4, SELECT_HIERARCHY_5, SELECT_ROUND, SELECT_LOCATION, CREATE_VISIT, SELECT_INDIVIDUAL, SELECT_EVENT, FINISH_VISIT, INMIGRATION
    }
    ...
    static {
        ...
        STATE_SEQUENCE.add(State.SELECT_HIERARCHY_5);
